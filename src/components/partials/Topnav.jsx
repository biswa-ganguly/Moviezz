  ...
  return (
    <div className='w-full h-[10vh] relative flex justify-start items-center ml-[10%]'>
        ...
        <div className='absolute z-[100] w-[50%] max-h-[50vh] top-[100%] left-[5%] bg-zinc-300 overflow-auto rounded'>
            {searches.map((s,i) => <Link to={`/${s.media_type || title}/details/${s.id}`} key={i } className='p-7  w-[100%]  flex justify-start items-center border-b-2 border-zinc-100 text-zinc-600 font-semibold hover:text-zinc-900 duration-200 hover:bg-zinc-400'>
